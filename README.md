...
1. Select **New registration**. On the **Register an application** page, set the values as follows.
    ...
    - Set **Name** to `Script Wave`.
    - Set **Supported account types** to **Accounts in any organizational directory and personal Microsoft accounts**.
    - Under **Redirect URI**, set the first drop-down to `Web` and set the value to `http://localhost:4200`.


1. Choose **Register**. On the **Script Wave** page, copy the value of the **Application (client) ID** and save it, you will need it in the next step.
...
1. In your command-line interface (CLI), navigate to this directory and run the following commands to install requirements.
